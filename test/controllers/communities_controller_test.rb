...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference("Community.count") do
      post communities_url, params: { community: { adress: @community.adress, name: @community.name, phone: @community.phone, verified: @community.verified } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { adress: @community.adress, name: @community.name, phone: @community.phone, verified: @community.verified } }
